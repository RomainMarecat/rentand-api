...
class AdvertRepository extends AbstractEntityRepository
{
    ...
    public function findAdvertSportsByAdvert($advert)
    {
        $query = $this->createQueryBuilder('entity');
        $query
            ->select('partial entity.{id}')
            ...
            ->addSelect('partial image.{id, filename, alt, ext}')
            ->innerJoin('entity.sports', 'advertSport')
            ->innerJoin('advertSport.pictures', 'image')
    ...
    public function findByBestAdverts($limit)
    {
        ...
        $query
            ...
            ->addSelect('partial i.{id, filename, alt, ext} as image')
    ...
    public function findStarsByAdvert($advert)
    {
        $query = $this->createQueryBuilder('entity');
        $query
    ...
    public function findLanguagesByAdvert($advert)
    {
        $query = $this->createQueryBuilder('entity');
        $query
    ...
    public function findTranslationsByAdvert($advert)
    {
        $query = $this->createQueryBuilder('entity');
        $query
            ->select('partial entity.{id}')
